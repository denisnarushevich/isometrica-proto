define(function () {
    ...
    Images.prototype.dirUrl = 'images/';
    Images.prototype.hash = {};
    Images.prototype.loadCount = 0;

    /**
     * preloads all image for browser to cache them in his internal cache
     */
    Images.prototype.load = function (onEachLoad) {
        var images = this;
    ...
    Images.prototype.loadProgress = function () {
        return this.loadCount / this.urns.length;
    };

    Images.prototype.currentLoadingName = function () {
        return this.loaded() ? 'done' : this.urns[this.loadCount];
    };

    Images.prototype.getImage = function (urn) {
